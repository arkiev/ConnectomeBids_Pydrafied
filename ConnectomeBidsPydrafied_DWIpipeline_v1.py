...
from pydra.tasks.mrtrix3.v3_0 import DwiDenoise,MrDegibbs, DwiFslpreproc, DwiBiasnormmask, Dwi2Mask_Fslbet, DwiBiascorrect_Ants, DwiBiascorrect_Fsl, TransformConvert,MrTransform, MrConvert, MrGrid, DwiExtract, MrCalc, MrMath, DwiBiasnormmask, MrThreshold,Dwi2Response_Dhollander, Dwi2Fod, MtNormalise,TckGen,TckSift2,Tck2Connectome, TckMap
...
output_path = '/Users/arkievdsouza/git/ConnectomeBids_Pydrafied/outputs/ConnectomeBidsPydrafied_DWIpipeline_v1/'
...
input_spec = {"dwi_preproc_mif": File, "FS_dir":str, "fTTvis_image_T1space":File,"fTT_image_T1space":File,"parcellation_image_T1space":File,} 

# Create a workflow 
wf = Workflow(name='DWIpipeline_wf', input_spec=input_spec, cache_dir=output_path,)# output_spec=output_spec) 
...
# Step 10: Apply transform (to get MeanB0 image in T1 space)
wf.add(
    MrTransform(
        name="transformMeanb0_task",
        in_file=wf.meanb0_task.lzout.out_file,
        out_file="MeanB0_registered.mif",
        linear=wf.transformconvert_task.lzout.out_file,
        strides=wf.nifti_t1brain.lzout.out_file,
    )
)

# Step 11: Apply transform (to get DWI image in T1 space)
wf.add(
    MrTransform(
...
# Step 11: Apply transform (to get DWImask image in T1 space)
wf.add(
    MrTransform(
...
result = wf(
    dwi_preproc_mif="/Users/arkievdsouza/Desktop/ConnectomeBids/output/MRtrix3_connectome-participant_brainnetome246fs/sub-01/scratch/dwi.mif",
    FS_dir="/Users/arkievdsouza/git/t1-pipeline/working-dir/T1_ProcessingPipeline_v1_testing/sub-01-PasCal/fastsurfer_0dfae532b1ba68e954e29e1f4b98af78/subjects_dir/FS_outputs/",
    fTTvis_image_T1space="/Users/arkievdsouza/git/t1-pipeline/working-dir/T1_ProcessingPipeline_v1_testing/sub-01-PasCal/Fivett2Vis_603fffdfa86cdbd542d1158a27a89506/5TTvis_hsvs.mif",
    fTT_image_T1space="/Users/arkievdsouza/git/t1-pipeline/working-dir/T1_ProcessingPipeline_v1_testing/sub-01-PasCal/FivettGen_Hsvs_e70246226c9c3d827b3922b5a36843c5/5TT_hsvs.mif",
    parcellation_image_T1space="/Users/arkievdsouza/git/t1-pipeline/working-dir/T1_ProcessingPipeline_v1_testing/sub-01-PasCal/parcellation_image_desikan.mif.gz",
    plugin="serial",
)
