...
# wf.set_output(("carriage3_dwi", wf.dwibiasnormmask_task.lzout.output_dwi))
...
# wf.set_output(("carriage3_meanb0", wf.meanb0_task.lzout.output))
# wf.set_output(("carriage3_output", wf.mrcalc_max.lzout.output_image))
